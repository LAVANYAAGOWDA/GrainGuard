...
export const Route = createFileRoute("/farmer/contact")({
  head: () => ({ meta: [{ title: "Contact Support — GrainGuard" }] }),
  component: FarmerContact,
});
    ...
    <PageShell>
      <section className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {t("Have a question? Our GrainGuard support team is here for you.", "ಪ್ರಶ್ನೆ ಇದೆಯೇ? ನಮ್ಮ ಬೆಂಬಲ ತಂಡ ನಿಮಗಾಗಿ ಇಲ್ಲಿದೆ.")}
        </p>
